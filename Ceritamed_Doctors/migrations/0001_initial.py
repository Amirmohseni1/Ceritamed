...
import Ceritamed_Doctors.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_img', models.ImageField(help_text='ابعاد مناسب عکس پزشکان 385 * 385 px', null=True, upload_to=Ceritamed_Doctors.models.upload_image_path, verbose_name='عکس پزشک')),
                ...
                ('doctor_evidence', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Ceritamed_Doctors.doctorevidence', verbose_name='سطح تحصیلی')),
                ('doctor_expertise', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Ceritamed_Doctors.doctorexpertise', verbose_name='تخصص پزشک')),
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='توانایی های پزشک')),
            ],
            options={
                'verbose_name': 'پزشک',
